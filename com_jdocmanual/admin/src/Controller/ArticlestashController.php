                        ...
                        if (empty($existing_page_id)) {
                            ...
                            if (empty($result)) {
                                ...
                                $this->app->enqueueMessage(
                                    sprintf(
                                        'COM_JDOCMANUAL_ARTICLES_SOURCE_URL_ADD_FAILED',
                                        $append_to
                                    ),
                                    'warning'
                                );
                                ...
                                $msg = 'Success: ';
                                $this->app->enqueueMessage(
                                    Text::_('COM_JDOCMANUAL_ARTICLES_SOURCE_URL_ADD_SUCCESS'),
                                    'success'
                                );
                            }
                            try {
                                file_put_contents(
                                    JPATH_SITE . 'administrator/logs/jdocmanual.php',
                                    $msg . $append_to . ' Entry: ' . $new_entry . "\n",
                                    FILE_APPEND
                                );
